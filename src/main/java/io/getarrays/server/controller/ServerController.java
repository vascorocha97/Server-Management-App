...
public class ServerController {
    ...
    public byte[] getServerImage(@PathVariable("fileName") String fileName) throws IOException {
       return Files.readAllBytes(Paths.get(System.getProperty("user.home") + "/Documents/Coding/Server Management (Spring_Angular)/Server-Management-App/server images/" + fileName));
    }
